...
def pcc_with_interpretability(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    """PCC
    ...
    **Algorithm Parameters:**
    ...
    return Algorithm(
        ...
        # ),
        main=DockerAdapter(
            image_name="thudth/pcc_interpretability",
            # tag="0.3.1",
            skip_pull=skip_pull,
            timeout=timeout,
            # group_privileges="akita",
