...
def copod_with_interpretability(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    """COPOD
    ...
    **Algorithm Parameters:**
    ...
    return Algorithm(
        ...
        # ),
        main=DockerAdapter(
            image_name="thudth/copod_interpretability",
            # tag="0.4.0",
            skip_pull=skip_pull,
            timeout=timeout,
            # group_privileges="akita",
