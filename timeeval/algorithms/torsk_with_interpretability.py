...
def torsk_with_interpretability(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    """Torsk
    ...
    **Algorithm Parameters:**
    ...
    return Algorithm(
        ...
        # ),
        main=DockerAdapter(
         image_name="thudth/torsk_interpretability",
         # tag="0.3.0",
         skip_pull=skip_pull,
         timeout=timeout,
         # group_privileges="akita",
