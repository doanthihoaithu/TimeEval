...
def cof_with_interpretability(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    """COF
    ...
    **Algorithm Parameters:**
    ...
    return Algorithm(
        ...
        # ),
        main=DockerAdapter(
            image_name="thudth/cof_interpretability",
            # tag="0.3.1",
            skip_pull=skip_pull,
            timeout=timeout,
            # group_privileges="akita",
