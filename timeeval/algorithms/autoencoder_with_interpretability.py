...
def autoencoder_with_interpretability(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    """AutoEncoder (AE)
    ...
    **Algorithm Parameters:**
    ...
    """
    return Algorithm(
        name="AutoEncoder (AE)_Interpretability",
        # main=DockerAdapter(
        ...
        # ),
        main=DockerAdapter(
            image_name="thudth/autoencoder_interpretability",
            # tag="0.3.0",
            skip_pull=skip_pull,
            timeout=timeout,
            # group_privileges="akita",
